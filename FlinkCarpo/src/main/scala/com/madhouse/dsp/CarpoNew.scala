...
import com.madhouse.dsp.utils.MysqlOut
  ...
  def main(args: Array[String]): Unit = {
    ...
    for (job <- jobs) {
      ...
      if (count > 0) {
        ...
        reqCampaignLDs.output(new MysqlOut[RequestCampaignWithLocation](REQCAML, jdbcConf, cLTable))
        ...
        reqMediaDs.output(new MysqlOut[RequestMedia](REQMED, jdbcConf, mTable))
        ...
        reqMediaLDs.output(new MysqlOut[RequestMediaWithLocation](REQMEDL, jdbcConf, mLTable))
      ...
      if(tCount >0){
        ...
        tCampaignDs.output(new MysqlOut[TrackCampaign](TRACAM, jdbcConf, cTable))
        ...
        tCampaignLDs.output(new MysqlOut[TrackCampaignWithLocation](TRACAML, jdbcConf, cLTable))
        ...
        tMediaDs.output(new MysqlOut[TrackMedia](TRAMED, jdbcConf, mTable))
        ...
        tMediaLDs.output(new MysqlOut[TrackMediaWithLocation](TRAMEDL, jdbcConf, mLTable))
